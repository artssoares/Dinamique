...
--
-- É seguro rodar quantas vezes quiser: ele não cria nem apaga nada, só
-- fecha permissões que estavam abertas.
--
-- Este arquivo é uma cópia exata da migration
-- packages/database/migrations/20260818001500_security_hardening.sql
-- ============================================================================
